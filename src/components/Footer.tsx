        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/property/1" className="text-gray-400 hover:text-white">Property Details</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Homes</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Flates</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="text-gray-400">123 Property Street,Mingora City,swat</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-blue-500 mr-3" />
                <span className="text-gray-400">+92 (346-5644839) (303-8929206)</span>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-blue-500 mr-3" />
                <span className="text-gray-400">info@nestifyHomes.com</span>
              </div>
            </div>
          </div>
        </div>
